                        ...
                        <div className="w-100 p-3 p-md-5 card border-0 bg-dark text-light" style={{maxWidth: "25rem"}}>
                            ...
                            <form className="row g-1 p-3 p-md-4">
                                ...
                                <div className="col-12 text-center mt-4">
                                    <Link to="/twostep" title="" className="btn btn-lg btn-block btn-light lift text-uppercase">SUBMIT</Link>
                                </div>
                                <div className="col-12 text-center mt-4">
                                    <span className="text-muted"><Link to="/login" className="text-secondary">Back to Sign in</Link></span>
                                </div>
                            </form>
